...
비지도 학습 알고리즘인 **K-Means Clustering**을 적용하여, 국가명(Label) 없이 오직 데이터 패턴만으로 윤리적 성향을 그룹화했습니다.
![Image](https://github.com/user-attachments/assets/13ba4107-f3bd-4081-b802-ac412f44cd39)
> **💡 검증 결과:**
> AI 알고리즘 역시 **서구권(효율 중시)**과 **동양권(규범 중시)**을 수학적으로 서로 다른 그룹으로 명확히 분류했습니다. 이는 문화권에 따른 윤리적 차이가 주관적 해석이 아닌 **통계적으로 유의미한 패턴**임을 입증합니다.
